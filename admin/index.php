...
<fieldset class="clearfix" style="margin-top: -11rem;">
  ...
  <p><input type="submit" name="sub"  value="Login" style="margin-block: auto;"></p>
    ...
    <div class="bottom">  <h3><a href="../index.php">GET AWAY HOMEPAGE</a></h3></div>
