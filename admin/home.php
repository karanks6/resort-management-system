        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="room.php"><i class="fa fa-desktop"></i>Room Settings </a>
                    </li>
                    <li>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												Newly Booked Rooms  <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-body'>
                                            ...
                                            <input name='usname' value='<?php echo $_SESSION["user"]; ?>' class='form-control' placeholder='Enter User name'>
											</div>
										</div>
										<div class='modal-body'>
                                            <div class='form-group'>
                                            <label>Change Password</label>
                                            <input name='pasd' value='<?php echo $_SESSION["pass"]; ?>' class='form-control' placeholder='Enter Password'>
											</div>
                                        </div>
